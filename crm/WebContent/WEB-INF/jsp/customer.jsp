...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/cust/list.action" method="get">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itcast:page url="${pageContext.request.contextPath }/cust/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		...
		function updateCustomer() {
			$.post("<%=basePath%>cust/update.action",$("#edit_customer_form").serialize(),function(data){
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				var param = {"id":id,"_method":"DELETE"};
				$.post("<%=basePath%>cust/delete.action",param,function(data){
					if (data == 'ok') {
						alert("客户删除更新成功！");
						window.location.reload();
					} else {
